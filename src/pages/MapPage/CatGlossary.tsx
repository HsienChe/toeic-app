        ...
        {filtered.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {filtered.map(w => {
              ...
              return (
                <div key={w.id} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '11px 14px', background: isFluent ? '#faf5ff' : '#fff', border: `1.5px solid ${isFluent ? '#c4b5fd' : '#f0f0f0'}`, borderRadius: 12 }}>
