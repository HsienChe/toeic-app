        ...
        <div className="map-page">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            {Object.entries(CAT_INFO).map(([key, info]) => (
              <div key={key} onClick={() => { setSelectedCat(key); setStep('glossary'); }}
                style={{ background: info.bg, border: `2px solid ${info.color}40`, borderRadius: 16, padding: 14, cursor: 'pointer', transition: 'all .2s' }}
